...
@Api(tags = "班级管理模块")
@RestController
@RequestMapping("/admin/getClazzs")
public class ClazzController {
    ...
    public ResultModel getClazzPage(
            ...
            @ApiParam(value = "班级名称") @RequestParam("clazzName") String clazzName) {
        Page<Clazz> page = new Page<>(pageNo, pageSize);
        // 通过服务层查询
        IPage<Clazz> pageGrade = gradeService.getClazzByOpr(page, clazzName);
    ...
    public ResultModel saveOrUpdateClazz(
            @ApiParam("班级信息") @RequestBody Clazz grade) {
    ...
    public ResultModel removeByIdsClazz(
